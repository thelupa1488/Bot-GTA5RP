...
bool ImGui::Hotkey(const char* label, int* k, const ImVec2& size_arg)
{
    ...
    ImGui::RenderFrame(frame_bb.Min, frame_bb.Max, ImGui::GetColorU32(g.ActiveId == id ? ImGuiCol_FrameBgActive : g.HoveredId == id ? ImGuiCol_FrameBgHovered : ImGuiCol_FrameBg), true, style.FrameRounding);
